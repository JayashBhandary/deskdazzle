...
export const TOOLS = [
  ...
  // --- Utilities ---
  { path: '/drive', name: 'Drive', icon: '🗂️', desc: 'File explorer — upload, folder, compress/extract .zip, convert files. Isolated per workspace.', keywords: 'drive files storage upload folder documents images pdf binary local disk filesystem explorer compress zip extract unzip convert', category: 'Utilities' },
